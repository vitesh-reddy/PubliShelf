//client/src/pages/publisher/sell-antique/SellAntique.jsx
...
const SellAntique = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.itemImage || !formData.authenticationImage) {
    ...
    Object.keys(formData).forEach((key) => {
      if (["itemImage", "authenticationImage"].includes(key)) {
    ...
    try {
      ...
      setError("Error starting auction");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                <div className="space-y-1 text-center">
                  ...
                  <div className="flex text-sm text-gray-600">
                    <label htmlFor="itemImage" className="relative cursor-pointer bg-white rounded-md font-medium text-purple-600 hover:text-purple-500">
                      <span>Upload Image</span>
                      <input id="itemImage" name="itemImage" type="file" onChange={handleItemImageChange} className="sr-only" accept="image/*" required />
                    </label>
              ...
              {imagePreview1 && (
                <div className="mt-4">
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Item Image Preview:</h4>
                  <img src={imagePreview1} alt="Preview" className="w-48 h-64 object-cover rounded-lg shadow-md" />
                </div>
              )}
            </div>
            ...
            <div>
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                <div className="space-y-1 text-center">
                  <FaCloudUploadAlt className="text-gray-400 text-3xl mx-auto" />
                  <div className="flex text-sm text-gray-600">
                    <label htmlFor="authenticationImage" className="relative cursor-pointer bg-white rounded-md font-medium text-purple-600 hover:text-purple-500">
                      <span>Upload Image</span>
                      <input id="authenticationImage" name="authenticationImage" type="file" onChange={handleAuthImageChange} className="sr-only" accept="image/*" required />
                    </label>
                    <p className="pl-1">or drag and drop</p>
                  </div>
                  <p className="text-xs text-gray-500">PNG, JPG, GIF up to 10MB</p>
              ...
              {imagePreview2 && (
                <div className="mt-4">
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Authentication Image Preview:</h4>
                  <img src={imagePreview2} alt="Preview" className="w-48 h-64 object-cover rounded-lg shadow-md" />
                </div>
              )}
            </div>
